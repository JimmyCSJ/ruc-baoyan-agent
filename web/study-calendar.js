...
(function () {
  ...
  let todos = [];
  let completions = {};
  let viewYear = appNowDate().getFullYear();
  let viewMonth = appNowDate().getMonth();
  ...
  function defaultStartDate() {
    return dateKeyFromDate(appNowDate());
  }
  ...
  function genId() {
    return `p_${appNowDate().getTime().toString(36)}_${Math.random().toString(36).slice(2, 7)}`;
  }
